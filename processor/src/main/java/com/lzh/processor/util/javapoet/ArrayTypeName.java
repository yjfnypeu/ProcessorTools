...
public final class ArrayTypeName extends TypeName {
  ...
  private ArrayTypeName(TypeName componentType) {
    this(componentType, new ArrayList<com.lzh.processor.util.javapoet.AnnotationSpec>());
  }

  private ArrayTypeName(TypeName componentType, List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
    super(annotations);
    this.componentType = checkNotNull(componentType, "rawType == null");
  }

  @Override public ArrayTypeName annotated(com.lzh.processor.util.javapoet.AnnotationSpec... annotations) {
    return annotated(Arrays.asList(annotations));
  }

  @Override public ArrayTypeName annotated(List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
