...
public final class MethodSpec {
  ...
  static final com.lzh.processor.util.javapoet.ClassName OVERRIDE = com.lzh.processor.util.javapoet.ClassName.get(Override.class);
  ...
  public final com.lzh.processor.util.javapoet.CodeBlock code;
  public final com.lzh.processor.util.javapoet.CodeBlock defaultValue;

  private MethodSpec(Builder builder) {
    com.lzh.processor.util.javapoet.CodeBlock code = builder.code.build();
  ...
  void emit(com.lzh.processor.util.javapoet.CodeWriter codeWriter, String enclosingName, Set<Modifier> implicitModifiers)
      throws IOException {
  ...
  public static Builder overriding(ExecutableElement method) {
    ...
    for (AnnotationMirror mirror : method.getAnnotationMirrors()) {
      com.lzh.processor.util.javapoet.AnnotationSpec annotationSpec = com.lzh.processor.util.javapoet.AnnotationSpec.get(mirror);
    ...
    for (VariableElement parameter : parameters) {
      ...
      for (AnnotationMirror mirror : parameter.getAnnotationMirrors()) {
        parameterBuilder.addAnnotation(com.lzh.processor.util.javapoet.AnnotationSpec.get(mirror));
      }
  ...
  public static final class Builder {
    ...
    private final com.lzh.processor.util.javapoet.CodeBlock.Builder code = com.lzh.processor.util.javapoet.CodeBlock.builder();
    private boolean varargs;
    private com.lzh.processor.util.javapoet.CodeBlock defaultValue;
    ...
    public Builder addCode(com.lzh.processor.util.javapoet.CodeBlock codeBlock) {
      code.add(codeBlock);
      return this;
    }

    public Builder defaultValue(String format, Object... args) {
      return defaultValue(com.lzh.processor.util.javapoet.CodeBlock.builder().add(format, args).build());
    }
