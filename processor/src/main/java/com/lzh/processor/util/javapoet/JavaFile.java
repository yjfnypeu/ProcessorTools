...
public final class JavaFile {
  ...
  public final com.lzh.processor.util.javapoet.CodeBlock fileComment;
  ...
  public void writeTo(Appendable out) throws IOException {
    ...
    com.lzh.processor.util.javapoet.CodeWriter importsCollector = new com.lzh.processor.util.javapoet.CodeWriter(NULL_APPENDABLE, indent);
    emit(importsCollector);
    Map<String, com.lzh.processor.util.javapoet.ClassName> suggestedImports = importsCollector.suggestedImports();

    // Second pass: write the code, taking advantage of the imports.
    com.lzh.processor.util.javapoet.CodeWriter codeWriter = new com.lzh.processor.util.javapoet.CodeWriter(out, indent, suggestedImports);
    emit(codeWriter);
  }
  ...
  private void emit(com.lzh.processor.util.javapoet.CodeWriter codeWriter) throws IOException {
  ...
  public static final class Builder {
    ...
    private com.lzh.processor.util.javapoet.CodeBlock.Builder fileComment = CodeBlock.builder();
