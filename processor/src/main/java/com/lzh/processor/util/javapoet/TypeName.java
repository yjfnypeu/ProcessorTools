 ...
 * com.lzh.processor.util.javapoet.ClassName#get(String, String, String...)}. To build composite types like {@code char[]} and
 * {@code Set<Long>}, use the factory methods on {@link com.lzh.processor.util.javapoet.ArrayTypeName}, {@link
 * com.lzh.processor.util.javapoet.ParameterizedTypeName}, {@link TypeVariableName}, and {@link WildcardTypeName}.
 */
public class TypeName {
  ...
  public static final com.lzh.processor.util.javapoet.ClassName OBJECT = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Object");

  private static final com.lzh.processor.util.javapoet.ClassName BOXED_VOID = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Void");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_BOOLEAN = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Boolean");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_BYTE = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Byte");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_SHORT = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Short");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_INT = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Integer");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_LONG = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Long");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_CHAR = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Character");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_FLOAT = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Float");
  private static final com.lzh.processor.util.javapoet.ClassName BOXED_DOUBLE = com.lzh.processor.util.javapoet.ClassName.get("java.lang", "Double");
  ...
  private TypeName(String keyword) {
    this(keyword, new ArrayList<com.lzh.processor.util.javapoet.AnnotationSpec>());
  }

  private TypeName(String keyword, List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
    this.keyword = keyword;
    this.annotations = Util.immutableList(annotations);
  }

  // Package-private constructor to prevent third-party subclasses.
  TypeName(List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
    this(null, annotations);
  }

  public TypeName annotated(com.lzh.processor.util.javapoet.AnnotationSpec... annotations) {
    Util.checkNotNull(annotations, "annotations == null");
    return new TypeName(keyword, Arrays.asList(annotations));
  }

  public TypeName annotated(List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
    Util.checkNotNull(annotations, "annotations == null");
  ...
  @Override public final String toString() {
    try {
      ...
      emit(new com.lzh.processor.util.javapoet.CodeWriter(result));
  ...
  com.lzh.processor.util.javapoet.CodeWriter emitAnnotations(com.lzh.processor.util.javapoet.CodeWriter out) throws IOException {
  ...
  static TypeName get(TypeMirror mirror,
    ...
    return mirror.accept(new SimpleTypeVisitor7<TypeName, Void>() {
      ...
      @Override public TypeName visitDeclared(DeclaredType t, Void p) {
        com.lzh.processor.util.javapoet.ClassName rawType = com.lzh.processor.util.javapoet.ClassName.get((TypeElement) t.asElement());
        ...
        return new com.lzh.processor.util.javapoet.ParameterizedTypeName(rawType, typeArgumentNames);
      }

      @Override public com.lzh.processor.util.javapoet.ArrayTypeName visitArray(ArrayType t, Void p) {
        return com.lzh.processor.util.javapoet.ArrayTypeName.get(t, typeVariables);
      }
  ...
  static TypeName get(Type type, Map<Type, TypeVariableName> map) {
    if (type instanceof Class<?>) {
      ...
      if (classType.isArray()) return com.lzh.processor.util.javapoet.ArrayTypeName.of(get(classType.getComponentType(), map));
      ...
      return com.lzh.processor.util.javapoet.ArrayTypeName.get((GenericArrayType) type, map);
  ...
  static TypeName arrayComponent(TypeName type) {
    return type instanceof com.lzh.processor.util.javapoet.ArrayTypeName
