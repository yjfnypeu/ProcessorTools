...
public final class ClassName extends TypeName implements Comparable<ClassName> {
  ...
  private ClassName(List<String> names) {
    this(names, new ArrayList<com.lzh.processor.util.javapoet.AnnotationSpec>());
  }

  private ClassName(List<String> names, List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
    super(annotations);
  ...
  @Override public ClassName annotated(com.lzh.processor.util.javapoet.AnnotationSpec... annotations) {
    return annotated(Arrays.asList(annotations));
  }

  @Override public ClassName annotated(List<com.lzh.processor.util.javapoet.AnnotationSpec> annotations) {
