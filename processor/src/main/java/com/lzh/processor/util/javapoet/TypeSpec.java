...
import static com.lzh.processor.util.javapoet.Util.hasDefaultModifier;
import static com.lzh.processor.util.javapoet.Util.requireExactlyOneOf;

/** A generated class, interface, or enum declaration. */
public final class TypeSpec {
  public final Kind kind;
  public final String name;
  public final com.lzh.processor.util.javapoet.CodeBlock anonymousTypeArguments;
  ...
  public final com.lzh.processor.util.javapoet.TypeName superclass;
  public final List<com.lzh.processor.util.javapoet.TypeName> superinterfaces;
  public final Map<String, TypeSpec> enumConstants;
  public final List<com.lzh.processor.util.javapoet.FieldSpec> fieldSpecs;
  public final com.lzh.processor.util.javapoet.CodeBlock staticBlock;
  public final List<com.lzh.processor.util.javapoet.MethodSpec> methodSpecs;
  ...
  public static Builder anonymousClassBuilder(String typeArgumentsFormat, Object... args) {
    return new Builder(Kind.CLASS, null, com.lzh.processor.util.javapoet.CodeBlock.builder()
  ...
  void emit(com.lzh.processor.util.javapoet.CodeWriter codeWriter, String enumName, Set<Modifier> implicitModifiers)
      throws IOException {
    ...
    try {
      if (enumName != null) {
        ...
        com.lzh.processor.util.javapoet.TypeName supertype = !superinterfaces.isEmpty() ? superinterfaces.get(0) : superclass;
        ...
        List<com.lzh.processor.util.javapoet.TypeName> extendsTypes;
        List<com.lzh.processor.util.javapoet.TypeName> implementsTypes;
        if (kind == Kind.INTERFACE) {
          extendsTypes = superinterfaces;
          implementsTypes = Collections.emptyList();
        } else {
          extendsTypes = superclass.equals(com.lzh.processor.util.javapoet.ClassName.OBJECT)
              ? Collections.<com.lzh.processor.util.javapoet.TypeName>emptyList()
        ...
        if (!extendsTypes.isEmpty()) {
          ...
          for (com.lzh.processor.util.javapoet.TypeName type : extendsTypes) {
        ...
        if (!implementsTypes.isEmpty()) {
          ...
          boolean firstType = true;
          for (com.lzh.processor.util.javapoet.TypeName type : implementsTypes) {
            if (!firstType) codeWriter.emit(",");
            codeWriter.emit(" $T", type);
            firstType = false;
          }
      ...
      // Static fields.
      for (com.lzh.processor.util.javapoet.FieldSpec fieldSpec : fieldSpecs) {
      ...
      // Constructors.
      for (com.lzh.processor.util.javapoet.MethodSpec methodSpec : methodSpecs) {
  ...
  public static final class Builder {
    ...
    private final com.lzh.processor.util.javapoet.CodeBlock anonymousTypeArguments;
    ...
    private com.lzh.processor.util.javapoet.TypeName superclass = com.lzh.processor.util.javapoet.ClassName.OBJECT;
    private final List<com.lzh.processor.util.javapoet.TypeName> superinterfaces = new ArrayList<>();
    private final Map<String, TypeSpec> enumConstants = new LinkedHashMap<>();
    private final List<com.lzh.processor.util.javapoet.FieldSpec> fieldSpecs = new ArrayList<>();
    private final com.lzh.processor.util.javapoet.CodeBlock.Builder staticBlock = com.lzh.processor.util.javapoet.CodeBlock.builder();
    private final List<com.lzh.processor.util.javapoet.MethodSpec> methodSpecs = new ArrayList<>();
    ...
    private Builder(Kind kind, String name,
        com.lzh.processor.util.javapoet.CodeBlock anonymousTypeArguments) {
    ...
    public Builder addAnnotation(Class<?> annotation) {
      return addAnnotation(com.lzh.processor.util.javapoet.ClassName.get(annotation));
    }
    ...
    public Builder superclass(com.lzh.processor.util.javapoet.TypeName superclass) {
      checkState(this.superclass == com.lzh.processor.util.javapoet.ClassName.OBJECT,
    ...
    public Builder superclass(Type superclass) {
      return superclass(com.lzh.processor.util.javapoet.TypeName.get(superclass));
    }

    public Builder addSuperinterfaces(Iterable<? extends com.lzh.processor.util.javapoet.TypeName> superinterfaces) {
      checkArgument(superinterfaces != null, "superinterfaces == null");
      for (com.lzh.processor.util.javapoet.TypeName superinterface : superinterfaces) {
        this.superinterfaces.add(superinterface);
      }
      return this;
    }

    public Builder addSuperinterface(com.lzh.processor.util.javapoet.TypeName superinterface) {
      this.superinterfaces.add(superinterface);
      return this;
    }

    public Builder addSuperinterface(Type superinterface) {
      return addSuperinterface(com.lzh.processor.util.javapoet.TypeName.get(superinterface));
    }
    ...
    public Builder addFields(Iterable<com.lzh.processor.util.javapoet.FieldSpec> fieldSpecs) {
    ...
    public Builder addField(com.lzh.processor.util.javapoet.FieldSpec fieldSpec) {
    ...
    public Builder addField(com.lzh.processor.util.javapoet.TypeName type, String name, Modifier... modifiers) {
    ...
    public Builder addMethods(Iterable<com.lzh.processor.util.javapoet.MethodSpec> methodSpecs) {
    ...
    public Builder addMethod(com.lzh.processor.util.javapoet.MethodSpec methodSpec) {
      if (kind == Kind.INTERFACE) {
